...
<div class="container">
  ...
  <form class="form-inline" action="../Controle/controleInscription.php" method="post">
...
<div class="container">
  <a href="listeAdherents.php">
    <button class="btn btn-default">Voir la liste des adherents</button>
  </a>
</div>
<div class="container">
  <a href="../logout.php">
